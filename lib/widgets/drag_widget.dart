...
import 'package:swipecard/widgets/profile_card.dart';
import 'package:swipecard/widgets/tag_widget.dart';
					...
					child: ValueListenableBuilder(
						...
						builder: (context, swipe, _) {
							return RotationTransition(
								...
								const AlwaysStoppedAnimation(-15 / 360): const AlwaysStoppedAnimation(15 / 360): const AlwaysStoppedAnimation(0),
									child: Stack(
										children: [
